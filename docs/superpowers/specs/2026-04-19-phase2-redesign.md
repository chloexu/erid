...
**Primary use cases:**
- **B — Codebase research**: Navigate and answer questions about historical codebases ("how does auth work in project X?")
- **D — Decision support**: Research a decision using both web sources and your personal KB, output structured pro/con grounded in your own preferences and history
